...
<!DOCTYPE HTML> 
 ...
 $('document').ready(function(){ 
  var imge=document.getElementById("pic").value();
  alert(imge);
 var backimage = { 'url':imge, 'img': null }; 
 ...
 var c = document.getElementByIdx_x('main'); 
 ...
 canvas.temp = document_createElement_x('canvas'); 
 canvas.draw = document_createElement_x('canvas'); 
 ...
 // 動態生一個 img 出來 
 backimage.img = document_createElement_x('img'); 
 ...
 <input id="resetbutton" type="button" value="Reset" /> 
    <input id="pic" type="hidden" value="<%= request.getParameter("picutre") %>"/>奖
 </body> 
 </html> 
